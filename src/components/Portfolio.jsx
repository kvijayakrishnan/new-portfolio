            ...
            <div className=' grid sm:grid-cols-2 md:grid-cols-3 gap-8 sm:px-0'>
                {portfolios.map(({id, src})=>(
                    ...
                    <div className='flex items-center justify-center'>
                        <button className=' font-thin text-xl w-1/2 px-4 py-3 m-2 duration-200 hover:scale-105'>Demo</button>
                        <button className='font-thin text-xl w-1/2 px-4 py-3 m-2 duration-200 hover:scale-105'>code</button>
                    </div>
                </div>
                ))}
