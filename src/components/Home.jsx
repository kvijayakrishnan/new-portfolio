    ...
    <div 
        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row'>
            <div className='flex flex-col justify-center h-full'>
                ...
                <a href="https://git.io/typing-svg"><img className='mt-2' src="https://readme-typing-svg.herokuapp.com?font=san&size=28&duration=2000&pause=100&color=FFFFFF&background=0517AC0B&random=false&width=435&lines=Frontend+Developer;Backend+Developer;Full+Stack+Developer" alt="Typing SVG" /></a>
